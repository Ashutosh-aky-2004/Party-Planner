            ...
            <form method="POST">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea class="w-full px-3 py-2 border rounded-md" id="address" name="address" required><?= htmlspecialchars($user['address']) ?></textarea>
                    </div>
                    <div>
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" name="is_admin" class="rounded" <?= $user['is_admin'] ? 'checked' : '' ?>>
                            <span>Admin User</span>
                        </label>
                    </div>
                    <div>
                        <label class="flex items-center space-x-2">
                            <input type="checkbox" name="is_active" class="rounded" <?= $user['is_active'] ? 'checked' : '' ?>>
