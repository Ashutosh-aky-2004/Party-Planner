      ...
      <?php if (isset($_SESSION['user_id'])) : ?>
        ...
        <div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-gray-900 shadow-lg ring-1 ring-gray-700 focus:outline-hidden hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" id="profile-dropdown">
          <div class="py-2 px-4" role="none">
            ...
            <a href="profile.php" class="block w-full px-4 py-2 text-left text-sm text-white hover:bg-gray-800 rounded" role="menuitem" tabindex="-1">Edit Profile</a>
            <a href="logout.php" class="block w-full px-4 py-2 text-left text-sm text-white hover:bg-gray-800 rounded" role="menuitem" tabindex="-1">Sign out</a>
          </div>
        </div>
      <?php else : ?>
